...
# return [(u'наложенный платеж',u'наложенный платеж'),(u'банковская
# карта',u'банковская карта')]
...
label_additional_information = Tech_Info.objects.get(
    id=1).label_additional_information
info_additional_information = Tech_Info.objects.get(
    id=1).info_additional_information
...
class Homepage_Form(forms.Form):
    num = forms.ChoiceField(
        label=label_buy_num, widget=forms.Select, choices=list_num())
...
class Orders_Form(forms.Form):
    ...
    additional_information = forms.CharField(
        label=label_additional_information,
        max_length=10000,
