...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Orders.payment_method'
        db.delete_column(u'mikro_app_orders', 'payment_method')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Orders.payment_method'
        db.add_column(u'mikro_app_orders', 'payment_method',
