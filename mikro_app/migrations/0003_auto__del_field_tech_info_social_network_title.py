...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tech_Info.social_network_title'
        db.delete_column(u'mikro_app_tech_info', 'social_network_title')


    def backwards(self, orm):
        # Adding field 'Tech_Info.social_network_title'
        db.add_column(u'mikro_app_tech_info', 'social_network_title',
                      self.gf('django.db.models.fields.CharField')(default=u'\u0422\u0430\u043a\u0436\u0435 \u0432\u044b \u043c\u043e\u0436\u0435\u0442\u0435 \u043d\u0430\u0439\u0442\u0438 \u043d\u0430\u0441', max_length=100, blank=True),
                      keep_default=False)
