...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mikro_app_static_img_text', (
            ...
            ('img', self.gf('django.db.models.fields.related.ForeignKey')(related_name='text_for_img', unique=True, to=orm['mikro_app.Static_Img'])),
            ('lang', self.gf('django.db.models.fields.CharField')(unique=True, max_length=3)),
        ))
    ...
    models = {
        ...
        u'mikro_app.static_img_text': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'img': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'text_for_img'", 'unique': 'True', 'to': u"orm['mikro_app.Static_Img']"}),
