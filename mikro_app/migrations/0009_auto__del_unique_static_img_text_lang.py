...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Static_Img_Text', fields ['lang']
        db.delete_unique(u'mikro_app_static_img_text', ['lang'])


    def backwards(self, orm):
        # Adding unique constraint on 'Static_Img_Text', fields ['lang']
        db.create_unique(u'mikro_app_static_img_text', ['lang'])
