...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Lang'
        db.create_table(u'mikro_app_lang', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lang_abbr', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('default', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'mikro_app', ['Lang'])

        # Adding field 'Tech_Info.lang'
        db.add_column(u'mikro_app_tech_info', 'lang',
                      self.gf('django.db.models.fields.CharField')(default=u'lang', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Lang'
        db.delete_table(u'mikro_app_lang')

        # Deleting field 'Tech_Info.lang'
        db.delete_column(u'mikro_app_tech_info', 'lang')
    ...
    models = {
        ...
        u'mikro_app.lang': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang_abbr': ('django.db.models.fields.CharField', [], {'max_length': '3'})
        },
        u'mikro_app.orders': {
        ...
        u'mikro_app.tech_info': {
            ...
            'lang': ('django.db.models.fields.CharField', [], {'default': "u'lang'", 'max_length': '3'}),
