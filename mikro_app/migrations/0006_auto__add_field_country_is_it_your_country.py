...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Country.is_it_your_country'
        db.add_column(u'mikro_app_country', 'is_it_your_country',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Country.is_it_your_country'
        db.delete_column(u'mikro_app_country', 'is_it_your_country')
