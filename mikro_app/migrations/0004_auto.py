...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field payment_method on 'Transport_Company'
        m2m_table_name = db.shorten_name(u'mikro_app_transport_company_payment_method')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('transport_company', models.ForeignKey(orm[u'mikro_app.transport_company'], null=False)),
            ('paymentmethod', models.ForeignKey(orm[u'mikro_app.paymentmethod'], null=False))
        ))
        db.create_unique(m2m_table_name, ['transport_company_id', 'paymentmethod_id'])


    def backwards(self, orm):
        # Removing M2M table for field payment_method on 'Transport_Company'
        db.delete_table(db.shorten_name(u'mikro_app_transport_company_payment_method'))
    ...
    models = {
        ...
        u'mikro_app.transport_company': {
            ...
            'payment_method': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['mikro_app.PaymentMethod']", 'symmetrical': 'False'}),
