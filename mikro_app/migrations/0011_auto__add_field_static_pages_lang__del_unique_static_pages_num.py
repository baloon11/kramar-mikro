...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Static_Pages', fields ['num']
        db.delete_unique(u'mikro_app_static_pages', ['num'])

        # Adding field 'Static_Pages.lang'
        db.add_column(u'mikro_app_static_pages', 'lang',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mikro_app.Language']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Static_Pages.lang'
        db.delete_column(u'mikro_app_static_pages', 'lang_id')

        # Adding unique constraint on 'Static_Pages', fields ['num']
        db.create_unique(u'mikro_app_static_pages', ['num'])
    ...
    models = {
        ...
        u'mikro_app.static_img_text': {
            ...
            'text': ('django.db.models.fields.CharField', [], {'default': "u'text'", 'max_length': '1000'})
        },
        u'mikro_app.static_pages': {
            'Meta': {'ordering': "['num']", 'object_name': 'Static_Pages'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lang': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mikro_app.Language']"}),
            'num': ('django.db.models.fields.IntegerField', [], {}),
